function get_arround(a, b, dir, size){
	...
	if size = 1{
		...
		for(var c = 0; c < 6; c++){
			var temp_complex = next_to(a, b, (dir + c) mod 6)
			ds_list_add(output, next_to(temp_complex.a, temp_complex.b, c))
			ds_list_add(output, next_to(temp_complex.a, temp_complex.b, (c + 1) mod 6))
		}
	}
	else if size = 4{
		if dir = 0{
		...
		for(var c = 0; c < 6; c++){
			var temp_complex = next_to(a, b, (dir + c) mod 6)
			var temp_complex_2 = next_to(temp_complex.a, temp_complex.b, c)
			ds_list_add(output, next_to(temp_complex_2.a, temp_complex_2.b, (c + 5) mod 6))
			ds_list_add(output, next_to(temp_complex_2.a, temp_complex_2.b, c))
			ds_list_add(output, next_to(temp_complex_2.a, temp_complex_2.b, (c + 1) mod 6))
		}
	}
	return output
}