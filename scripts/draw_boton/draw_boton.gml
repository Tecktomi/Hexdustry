function draw_boton(x, y, texto, back_color = ui_gris, text_color = control.ui_texto, boton = mb_left, box = true, input_layer = 0, round_box = true){
	with control{
		...
		var hover = (input_layer = control.input_layer and mouse_x > x - xx and mouse_y > y - yy and ((box and mouse_x < x + width + 8 - xx and mouse_y < y + height + 8 - yy) or (not box and mouse_x < x + width - xx and mouse_y < y + height - yy)))
		if box{
