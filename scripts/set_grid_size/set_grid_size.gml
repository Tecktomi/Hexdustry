function set_grid_size(){
	with control{
		...
		ds_grid_resize(chunk_dron_enemigo, chunk_xsize, chunk_ysize)
		ds_grid_resize(chunk_dron_aliado, chunk_xsize, chunk_ysize)
		ds_grid_resize(chunk_edificios, chunk_xsize, chunk_ysize)
		ds_grid_resize(chunk_edificios_enemigo, chunk_xsize, chunk_ysize)
		ds_grid_resize(chunk_edificios_abandonado, chunk_xsize, chunk_ysize)
