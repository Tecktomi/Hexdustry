function mover(aa, bb){
	with control{
		...
		if flag{
			...
			if in(out, 9, 10, 11) and not (edificio_camino[temp_edificio.index] or in(edificio_nombre[temp_edificio.index], "Túnel", "Túnel salida", "Planta Química", "Refinería de Metales"))
				out = 6
			...
			if edificio.receptor or in(var_edificio_nombre, "Túnel", "Túnel salida")
				mover_in(edificio)
		}
		return flag
	}
