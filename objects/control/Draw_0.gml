		...
		//Detalles Recurso
			...
			for(var a = 0; a < edificio_max; a++)
				for(var b = 0; b < array_length(edificio_input_id[a]); b++)
					if edificio_input_id[a, b] = enciclopedia_item{
						if draw_boton(140, pos, edificio_nombre[a],,,, false){
							enciclopedia_item = a
							enciclopedia = 4
							exit
						}
			...
			for(var a = 0; a < edificio_max; a++)
				for(var b = 0; b < array_length(edificio_output_id[a]); b++)
					if edificio_output_id[a, b] = enciclopedia_item{
						if draw_boton(140, pos, edificio_nombre[a],,,, false){
							enciclopedia_item = a
							enciclopedia = 4
							exit
...
if temp_hexagono != noone and flag{
	...
	if edificio_bool[# mx, my]{
		...
		if mouse_check_button_pressed(mb_left) and build_index = 0 and build_menu = 0 and in(var_edificio_nombre, "Selector", "Overflow", "Líquido Infinito", "Recurso Infinito", "Planta Química"){
			mouse_clear(mb_left)
			show_menu = true
