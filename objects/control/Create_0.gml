...
#region GRIDS
	...
	temperatura = ds_grid_create(xsize, ysize)
	ds_grid_clear(temperatura, 0)
...
function def_edificio_2(energia = 0, agua = 0, agua_consumo = 0, agua_tipo = array_create(0, 0), arma = -1, alcance = 0, inerte = false, prioridad = 0, _temperatura = 0, agua_2_consumo = 0){
	...
	array_push(edificio_temperatura, _temperatura)
	array_push(edificio_flujo_2_consumo, agua_2_consumo)
}
#region Definición
	id_nucleo = def_edificio("Núcleo", 3, spr_base,, 1500,,,,,,,,, true); def_edificio_2(,,,,,, true)
	id_taladro = def_edificio("Taladro", 2, spr_taladro,, 200, 120, scr_taladro,,,, [idr_cobre], [15], 10,,,,, true, false, [idr_cobre, idr_carbon, idr_hierro]); def_edificio_2()
	...
	id_horno = def_edificio("Horno", 2, spr_horno, spr_horno_encendido, 250, 150, scr_horno, scr_draw_hornos, false,, [idr_cobre, idr_hierro], [10, 20], 90, true, false, [idr_cobre, idr_carbon, idr_hierro, idr_arena, idr_compuesto_incendiario, idr_sal], [10, 10, 10, 10, 10, 10], true, false, [idr_bronce, idr_acero, idr_silicio]); def_edificio_2(,,,,,,, 1, 2)
	id_taladro_electrico = def_edificio("Taladro Eléctrico", 3, spr_taladro_electrico,, 400, 45, scr_taladro,,,, [idr_bronce, idr_acero], [20, 10], 20,,,,, true, false, [idr_cobre, idr_carbon, idr_hierro, idr_arena, idr_piedra, idr_piedra_cuprica, idr_piedra_ferrica, idr_piedra_sulfatada, idr_sal]); def_edificio_2(50, 10, 20, [idl_agua],,,, 1, 1)
	id_triturador = def_edificio("Triturador", 2, spr_triturador,, 250, 20, scr_triturador,, false,, [idr_cobre, idr_bronce, idr_acero], [10, 10, 15], 50, true, false, [idr_piedra, idr_piedra_cuprica, idr_piedra_ferrica, idr_piedra_sulfatada], [10, 10, 10, 10], true, false, [idr_arena]); def_edificio_2(30,,,,,,, 1, 1)
	//10
	id_generador = def_edificio("Generador", 1, spr_generador, spr_generador_encendido, 100,, scr_generador, scr_draw_hornos, false,, [idr_cobre, idr_hierro], [20, 5], 20, true, false, [idr_carbon, idr_compuesto_incendiario], [10, 10], false); def_edificio_2(-30,,,,,,, 2, 2)
	id_cable = def_edificio("Cable", 1, spr_cable,, 30,,,,,, [idr_cobre, idr_hierro], [5, 1]); def_edificio_2(,,,,,, true)
	id_bateria = def_edificio("Batería", 1, spr_bateria,, 60,,, scr_draw_bateria, false,, [idr_bronce, idr_bateria], [10, 3]); def_edificio_2(,,,,,, true, 2)
	id_panel_solar = def_edificio("Panel Solar", 2, spr_panel_solar,, 150,, scr_panel_solar,,,, [idr_cobre, idr_bronce, idr_silicio], [20, 10, 5]); def_edificio_2(-10,,,,,,, 2)
	id_bomba_hidraulica = def_edificio("Bomba Hidráulica", 2, spr_bomba,, 200,, scr_bomba_hidraulica, scr_draw_bomba_par, false,, [idr_cobre, idr_bronce, idr_hierro], [25, 25, 10]); def_edificio_2(40, 60, -80,,,,, 2, 1)
	id_tuberia = def_edificio("Tubería", 1, spr_tuberia, spr_tuberia_color, 30,,, scr_draw_tuberia, false,, [idr_hierro, idr_bronce], [1, 1]); def_edificio_2(, 10,,,,, true)
	...
	//20
	id_rifle = def_edificio("Rifle", 2, spr_rifle, spr_rifle_2, 400, 30, scr_torres_basicas, scr_draw_armas_no_laser, false,, [idr_cobre, idr_hierro, idr_acero], [20, 40, 10], 30, true, false, [idr_bronce, idr_acero, idr_uranio_bruto, idr_uranio_enriquecido, idr_uranio_empobrecido], [10, 10, 10, 10, 10]); def_edificio_2(, 10, 30, [idl_agua], 1, 300,, 3)
	id_lanzallamas = def_edificio("Lanzallamas", 2, spr_lanzallamas, spr_lanzallamas_2, 400, 1, scr_torres_basicas, scr_draw_armas_no_laser, false,, [idr_cobre, idr_bronce, idr_hierro], [20, 15, 20], 20, true, false, [idr_carbon, idr_compuesto_incendiario], [10, 10]); def_edificio_2(, 10, 30, [idl_petroleo], 3, 130,, 3, 2)
	id_planta_quimica = def_edificio("Planta Química", 3, spr_planta_quimica,, 200, 60, scr_planta_quimica,,,, [idr_cobre, idr_bronce, idr_hierro, idr_silicio], [30, 10, 30, 10], 30, true, false, [idr_cobre, idr_piedra_sulfatada, idr_compuesto_incendiario, idr_sal], [0, 0, 0, 10], true, false, [idr_explosivo, idr_bateria]); def_edificio_2(50, 10,, [idl_acido],,,, 1, 1)
	id_laser = def_edificio("Láser", 2.5, spr_laser, spr_laser_2, 400, 1, scr_laser,, false,, [idr_cobre, idr_acero, idr_silicio, idr_electronicos], [50, 15, 15, 5]); def_edificio_2(200,,,, 0, 320,, 3, 2)
	...
	id_turbina = def_edificio("Turbina", 2, spr_turbina,, 160,, scr_turbina, scr_draw_bomba_par, false,, [idr_cobre, idr_bronce, idr_acero], [20, 10, 10], 20, true, false, [idr_carbon, idr_compuesto_incendiario], [10, 10]); def_edificio_2(-120, 10, 40, [idl_agua],,,, 2, 2)
	id_refineria_de_metales = def_edificio("Refinería de Metales", 3, spr_refineria_minerales,, 150, 80, scr_refineria_metales,,,, [idr_bronce, idr_acero, idr_silicio], [15, 15, 10], 30, true, false, [idr_piedra_cuprica, idr_piedra_ferrica, idr_uranio_bruto], [5, 5, 10], true, false, [idr_cobre, idr_hierro, idr_uranio_enriquecido, idr_uranio_empobrecido]); def_edificio_2(50, 10, 20, [idl_acido],,,, 1, 1)
	id_fabrica_de_drones = def_edificio("Fábrica de Drones", 2, spr_fabrica_drones, spr_fabrica_drones_diagonal, 200,, scr_fabrica_drones,,,, [idr_cobre, idr_acero, idr_electronicos], [30, 15, 10], 20, true, false, [], []); def_edificio_2(120,,,,,,, 3, 1)
	...
	id_horno_de_lava = def_edificio("Horno de Lava", 2.5, spr_horno_lava, spr_horno_lava_encendido, 400, 70, scr_horno_lava,,,, [idr_acero, idr_concreto], [15, 15], 70, true, false, [idr_cobre, idr_hierro, idr_arena, idr_sal], [10, 10, 10, 10], true, false, [idr_bronce, idr_acero, idr_silicio]); def_edificio_2(, 10, 45, [idl_lava],,,, 1, 3)
	id_generador_geotermico = def_edificio("Generador Geotérmico", 2, spr_generador_geotermico,, 200,, scr_generador_geotermico, scr_draw_bomba_par, false,, [idr_cobre, idr_acero, idr_concreto], [60, 10, 10]); def_edificio_2(-90, 10, 30, [idl_agua, idl_agua_salada],,,, 2, 3)
	id_taladro_de_explosion = def_edificio("Taladro de Explosión", 3, spr_taladro_explosivo,, 300, 300, scr_taladro_explosion,,,, [idr_hierro, idr_acero, idr_concreto], [100, 40, 30], 40, true, false, [13], [10], true, false, [idr_cobre, idr_carbon, idr_hierro, idr_piedra, idr_arena, idr_piedra_cuprica, idr_piedra_ferrica, idr_piedra_sulfatada, idr_uranio_bruto, idr_sal]); def_edificio_2(,,,,,,, 1, 2)
	...
	id_ensambladora = def_edificio("Ensambladora", 2.5, spr_ensambladora,, 250, 240, scr_ensambladora,,,, [idr_hierro, idr_bronce, idr_acero, idr_silicio], [25, 15, 5, 10], 40, true, false, [idr_cobre, idr_silicio], [10, 10], true, false, [idr_electronicos]); def_edificio_2(70,,,,,,, 1, 2)
	id_planta_nuclear = def_edificio("Planta Nuclear", 4, spr_planta_nuclear,, 500,, scr_planta_nuclear,,,, [idr_cobre, idr_acero, idr_concreto, idr_electronicos], [250, 80, 50, 20], 10, true, false, [idr_uranio_enriquecido], [10]); def_edificio_2(-500, 150, 200, [idl_agua, idl_agua_salada],,,, 3, 3)
	...
	id_perforadora_de_petroleo = def_edificio("Perforadora de Petróleo", 3, spr_perforadora,, 200,, scr_perforadora_petroleo, scr_draw_bomba_impar, false,, [idr_hierro, idr_acero, idr_concreto], [50, 15, 10]); def_edificio_2(80, 10, -40, [idl_petroleo],,,, 2, 1)
	//40
	...
	id_procesador = def_edificio("Procesador", 2, spr_procesador,, 80,, scr_procesador,,,, [idr_cobre, idr_plastico, idr_electronicos], [50, 20, 20]); def_edificio_2(10,,,,,,, 1, 1)
	...
	id_torre_reparadora = def_edificio("Torre Reparadora", 2, spr_torre_reparadora, spr_torre_reparadora_2, 100,, scr_torre_reparadora, scr_draw_armas_no_laser, false,, [idr_cobre, idr_hierro, idr_bronce, idr_silicio], [25, 25, 15, 15]); def_edificio_2(40,,,, 0, 200,, 3)
	...
	id_onda_de_choque = def_edificio("Onda de Choque", 2, spr_onda_de_choque,, 800, 150, scr_onda_choque, scr_draw_armas_no_laser,,, [idr_cobre, idr_bateria, idr_electronicos], [80, 10, 10]); def_edificio_2(300,,,, 0, 100,, 3, 2)
	...
	id_planta_de_enriquecimiento = def_edificio("Planta de Enriquecimiento", 4, spr_planta_breeding,, 600, 600, scr_planta_enriquecimiento,,,, [idr_cobre, idr_acero, idr_concreto, idr_electronicos, idr_uranio_bruto], [150, 80, 40, 50, 100], 21, true, false, [idr_uranio_enriquecido, idr_uranio_empobrecido], [20, 1], true, false, [18]); def_edificio_2(200, 10, 150, [idl_agua, idl_agua_salada],,,, 2, 2)
	//50
