...
//EDIFICIOS
edificio_sprite =		[spr_base,	spr_taladro,	spr_camino,				spr_enrutador,	spr_selector,		spr_overflow,	spr_tunel,	spr_horno,				spr_generador,				spr_cable,	spr_bateria,	spr_taladro_electrico]//Sprite
edificio_sprite_2 =		[spr_base,	spr_taladro,	spr_camino,				spr_enrutador,	spr_selector_color,	spr_overflow,	spr_tunel,	spr_horno_encendido,	spr_generador_encendido,	spr_cable,	spr_bateria,	spr_taladro_electrico]//Sprite 2
edificio_nombre =		["Nucleo",	"Taladro",		"Cinta transportadora",	"Enrutador",	"Selector",			"Overflow",		"Tunel",	"Horno",				"Generador",				"Cable",	"Bateria",		"Taladro electrico"]//Nombre
edificio_size =			[3,			2,				1,						1,				1,					1,				1,			2,						1,							1,			1,				3]//Size
edificio_receptor =		[true,		false,			true,					true,			true,				true,			true,		true,					true,						false,		false,			false]//Receptor
edificio_emisor =		[false,		true,			true,					true,			true,				true,			true,		true,					false,						false,		false,			true]//Emisor
edificio_carga_max =	[0,			10,				1,						1,				1,					1,				1,			10,						10,							0,			0,				20]//Carga max
edificio_input_all =	[true,		true,			true,					true,			true,				true,			true,		false,					false,						false,		false,			false]//Input: all
edificio_input_index =	[[0],		[0],			[0],					[0],			[0],				[0],			[0],		[0, 1, 3],				[1],						[0],		[0],			[0]]//Input: index
edificio_input_num =	[[0],		[0],			[0],					[0],			[0],				[0],			[0],		[2, 2, 2],				[10],						[0],		[0],			[0]]//Input: num
edificio_output_all =	[true,		false,			true,					true,			true,				true,			true,		false,					false,						false,		false,			true]//Output: all
edificio_output_index = [[0],		[0, 1, 3],		[0],					[0],			[0],				[0],			[0],		[2, 4],					[0],						[0],		[0],			[0, 1, 3]]//Output: index
edificio_rotable =		[false,		true,			true,					true,			true,				true,			true,		true,					false,						false,		false,			false]//Rotable
edificio_proceso =		[0,			100,			20,						20,				20,					20,				20,			150,					0,							0,			0,				60]//Steps proceso
edificio_combutable =	[false,		false,			false,					false,			false,				false,			false,		true,					true,						false,		false,			false]//Combustable
edificio_camino =		[false,		false,			true,					true,			true,				true,			false,		false,					false,						false,		false,			false]//Es camino?
edificio_electricidad = [false,		false,			false,					false,			false,				false,			false,		false,					true,						true,		true,			true]//Se conecta a la red electrica?
edificio_elec_consumo = [0,			0,				0,						0,				0,					0,				0,			0,						-60,						1,			0,				200]//Consumo electrico (negativos para generadores)
