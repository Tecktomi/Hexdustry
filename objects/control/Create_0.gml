...
#region Tipos de disparos
	armas = [
		...
		[{recurso : id_bronce, cantidad : 0.5, dmg : 80}, {recurso : id_acero, cantidad : 0.5, dmg : 100}, {recurso : id_uranio_bruto, cantidad : 1, dmg : 150}],
...
#region Definición
	...
	//20
	id_rifle = def_edificio("Rifle", 2, spr_rifle, spr_rifle_2, 400, 45, scr_torres_basicas,, [id_cobre, id_hierro, id_acero], [10, 10, 10], 30, true, false, [id_bronce, id_acero, id_uranio_bruto, id_uranio_enriquecido, id_uranio_empobrecido], [10, 10, 10, 10, 10]); def_edificio_2(, 10, 30, 1, 300)
	id_lanzallamas = def_edificio("Lanzallamas", 2, spr_lanzallamas, spr_lanzallamas_2, 400, 1, scr_torres_basicas,, [id_cobre, id_bronce, id_hierro], [15, 15, 10], 20, true, false, [id_carbon, id_combustible], [10, 10]); def_edificio_2(, 10, 30, 3, 130)
	...
	id_horno_de_lava = def_edificio("Horno de Lava", 2, spr_horno_lava, spr_horno_lava_encendido, 400, 90, scr_horno_lava,, [id_acero, id_concreto], [15, 10], 60, true, false, [id_cobre, id_hierro, id_arena], [10, 10, 10], true, false, [id_bronce, id_acero, id_silicio]); def_edificio_2(, 10, 15)
	...
	id_planta_nuclear = def_edificio("Planta Nuclear", 4, spr_planta_nuclear,, 500,, scr_planta_nuclear,, [id_cobre, id_acero, id_concreto, id_electronico], [100, 80, 50, 20], 21, true, false, [id_uranio_enriquecido, id_uranio_empobrecido], [1, 20]); def_edificio_2(-800, 150, 200)
	...
	id_perforadora_de_petroleo = def_edificio("Perforadora de Petróleo", 3, spr_perforadora,, 200,, scr_perforadora_petroleo,, [id_hierro, id_acero, id_concreto], [10, 15, 10]); def_edificio_2(120, 10, -20)
	//40
	...
	id_silo_de_misiles = def_edificio("Silo de Misiles", 4, spr_silo_de_misiles,, 1600, 1200, scr_silo_misiles,, [id_bronce, id_concreto, id_electronico], [200, 100, 50], 200, true, false, [id_acero, id_explosivo, id_uranio_enriquecido, id_uranio_empobrecido], [120, 30, 45, 5]); def_edificio_2(300, 10, 50)
	id_planta_de_enriquecimiento = def_edificio("Planta de Enriquecimiento", 4, spr_planta_breeding,, 600, 600, scr_planta_enriquecimiento,, [id_cobre, id_acero, id_concreto, id_electronico, id_uranio_bruto], [30, 80, 40, 50, 100], 21, true, false, [id_uranio_enriquecido, id_uranio_empobrecido], [20, 1], true, false, [18]); def_edificio_2(200, 10, 150)
	//50
...
categoria_edificios = [
	...
	[id_horno, id_triturador, id_fabrica_de_concreto, id_ensambladora, id_planta_quimica, id_refineria_de_metales, id_refineria_de_petroleo, id_horno_de_lava, id_planta_de_reciclaje, id_planta_de_enriquecimiento],
	...
	[id_tuberia, id_tuberia_subterranea, id_bomba_de_evaporacion, id_bomba_hidraulica, id_deposito],
	[id_torre_basica, id_rifle, id_lanzallamas, id_laser, id_mortero, id_torre_reparadora, id_muro, id_muro_reforzado, id_silo_de_misiles],
