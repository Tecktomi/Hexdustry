...
#region Definición
	...
	id_turbina = def_edificio("Turbina", 2, spr_turbina,, 160,, scr_turbina, scr_draw_bomba_par, false,, [idr_cobre, idr_bronce, idr_acero], [20, 10, 10], 20, true, false, [idr_carbon, idr_compuesto_incendiario], [10, 10]); def_edificio_2(-120, 10, 50, idl_agua,,,, 2)
	...
	id_generador_geotermico = def_edificio("Generador Geotérmico", 2, spr_generador_geotermico,, 200,, scr_generador_geotermico, scr_draw_bomba_par, false,, [idr_cobre, idr_acero, idr_concreto], [60, 10, 10]); def_edificio_2(-90, 10, 30, idl_agua,,,, 2)
	...
	id_planta_nuclear = def_edificio("Planta Nuclear", 4, spr_planta_nuclear,, 500,, scr_planta_nuclear,,,, [idr_cobre, idr_acero, idr_concreto, idr_electronicos], [250, 80, 50, 20], 21, true, false, [idr_uranio_enriquecido, idr_uranio_empobrecido], [1, 20]); def_edificio_2(-500, 150, 200, idl_agua,,,, 3)
	...
	id_silo_de_misiles = def_edificio("Silo de Misiles", 4, spr_silo_de_misiles,, 1600, 1200, scr_silo_misiles,,,, [idr_cobre, idr_bronce, idr_hierro, idr_concreto, idr_electronicos], [500, 100, 500, 100, 50], 200, true, false); def_edificio_2(300, 10, 200, 2,,,, 4)
