...
/*
edificio[0] = {sprite: spr_base, nombre: "Nucleo", size: 3, receptor: true, input_all: true, emisor: false, carga_max: 0, activo: false}
edificio[1] = {sprite: spr_taladro, nombre: "Taladro", size: 2, receptor: false, emisor: true, output_all: false, output_index: [0, 1, 3], carga_max: 10, activo: true, }
for(var a = 0; a < array_length(edificio); a++){
	edificio_sprite[a] = edificio[a].sprite
	edificio_sprite_2[a] = edificio[a].sprite
	edificio_nombre[a] = edificio[a].nombre
	edificio_size[a] = edificio[a].size
}
*/
edificio_sprite = [spr_base, spr_taladro, spr_camino, spr_enrutador, spr_selector, spr_overflow, spr_horno, spr_invernadero, spr_silo]
edificio_sprite_2 = [spr_base, spr_taladro, spr_camino, spr_enrutador, spr_selector_color, spr_horno_encendido, spr_overflow, spr_invernadero, spr_silo]
edificio_nombre = ["Nucleo", "Taladro", "Cinta transportadora", "Enrutador", "Selector", "Overflow", "Horno", "Invernadero", "Silo"]
edificio_size = [3, 2, 1, 1, 1, 1, 2, 4, 5]
edificio_receptor = [true, false, true, true, true, true, true, false, true]
edificio_emisor = [false, true, true, true, true, true, true, true, false]
edificio_carga_max = [0, 10, 1, 1, 1, 1, 10, 20, 100]
edificio_input_all = [true, true, true, true, true, true, false, true, true]
edificio_input_index = [[0], [0], [0], [0], [0], [0], [0, 1, 3], [0], [0]]
edificio_input_num = [[0], [0], [0], [0], [0], [0], [2, 2, 2], [0], [0]]
edificio_output_all = [true, true, true, true, true, true, false, true, true]
edificio_output_index = [[0], [0], [0], [0], [0], [0], [2, 4], [0], [0]]
edificio_proceso = [0, 100, 20, 20, 20, 20, 150, 120, 0]
edificio_combutable = [false, false, false, false, false, false, true, false, false]
edificio_combustion = [0, 0, 0, 0, 0, 0, 360, 0, 0]
